export type GMAddStyle = ((style: string) => HTMLStyleElement) | void

export type GMInfo = ScriptGetInfo

/**
 * @see {@link https://www.tampermonkey.net/documentation.php?locale=en#api:GM_info GM_info Documentation | Tampermonkey}
 */
type ScriptGetInfo = {
  container?: {
    // 5.3+ | Firefox only
